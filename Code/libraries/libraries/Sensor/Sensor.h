...
/*
	Ein Sensor wird im System über den Nodenamen, der innerhalb des Nodes eindeutig ist)
	identifiziert.
...
class Sensor
{
  public:
	...
	*/
	Sensor(const char *nodeName, const char *name, const char *unit, float threshold);
