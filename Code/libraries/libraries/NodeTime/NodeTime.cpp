...
*/
void NodeTimeClass::sendNTPpacket(IPAddress &address)
{
...
*/
time_t NodeTimeClass::getNtpTime()
{
...
*/
void NodeTimeClass::setNtpTimeSubscriber() {
...
*/
time_t NodeTimeClass::getDateTime() {
	return now();
}
...
*/
void NodeTimeClass::setNodeTime(time_t time) {
	setTime(time);
}
...
*/
void NodeTimeClass::getTextDateTime(char* textTime)
{
