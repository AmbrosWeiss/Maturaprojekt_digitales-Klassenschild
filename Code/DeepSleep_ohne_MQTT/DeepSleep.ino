...
long int getSleepingTime()
{
  ...
  if(aktuellerWochentag > 0 && aktuellerWochentag <=5)
  {
      ...
      if(wakeuptimeWeekdays[aktuelleStunde+1] <= aktuelleMinute)
      {
        ...
        time_t aktuelleUhrzeit = tmConvert_t(timeClient.getYear(sec), timeClient.getMonth(sec), timeClient.getDayNumber(sec), timeClient.getHours(),timeClient.getMinutes(), timeClient.getSeconds());
        ...
        time_t aufwachzeit = tmConvert_t(timeClient.getYear(sec), timeClient.getMonth(sec), timeClient.getDayNumber(sec), aktStd+1, wakeuptimeWeekdays[aktuelleStunde+1], timeClient.getSeconds());
